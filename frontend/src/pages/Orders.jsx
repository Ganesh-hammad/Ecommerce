...
const Orders = () => {
  const { token, setToken, backendUrl, currency } = useContext(ShopContext);
            ...
            <div key={index} className="py-4 border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-start gap-6 text-sm">
                ...
                <div className="">
                  ...
                  <p className='mt-1 '>Date:<span className="text-gray-400">{new Date(item.date).toDateString()}</span>
                  </p>
